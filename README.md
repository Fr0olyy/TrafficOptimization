# UrbanQ - атомикХак 2025

## 🚀 Обзор проекта

**UrbanQ** — это гибридное решение для оптимизации дорожного трафика в крупных городах, сочетающее классические алгоритмы оптимизации с квантовыми вычислениями на базе MIREA Quantum Computer.
